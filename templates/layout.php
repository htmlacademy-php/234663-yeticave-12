...
<head>
    <meta charset="UTF-8">
    <title><?= $title; ?></title> <!--Используем переменную для вывода названия страницы -->
...
<header class="main-header">
    <div class="main-header__container container">
        ...
        <nav class="user-menu">
        <!--  Создаём условие для сравнения переменной $is_auth -->
        <?php if ($is_auth === 1) : ?>
        <div class="user-menu__logged"> <!-- Блок если условие равно true -->
    		<p><?=$user_name?></p>
    		<a class="user-menu__bets" href="pages/my-bets.html">Мои ставки</a>
    		<a class="user-menu__logout" href="#">Выход</a>
  		</div>
    	<?php else : ?> <!-- Блок если условие равно false -->
...
<main class="container">
    <?= $content; ?> <!-- Используем переменную для вывода файла main.php -->
</main>
</div>
...
<footer class="main-footer">
    <nav class="nav">
        <ul class="nav__list container">
            <!--Заполняем навигацию списком категорий -->
